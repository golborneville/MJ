...
public class go_cal_te extends AppCompatActivity implements EasyPermissions.PermissionCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_go_cal_te);
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, String> {
        ...
        public go_cal_te mActivity;
        List<String> eventStrings = new ArrayList<>();


        public MakeRequestTask(go_cal_te activity, GoogleAccountCredential credential) {
            ...
            if (mLastError != null) {
                if (mLastError instanceof GooglePlayServicesAvailabilityIOException) {
                    ...
                    startActivityForResult(
                            ...
                            go_cal_te.REQUEST_AUTHORIZATION);
                } else {
